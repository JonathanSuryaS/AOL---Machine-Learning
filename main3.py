...
def EDA():
    ...
    plot_type = ['Lineplot', 'Scatterplot', 'Barplot']
    plotting_type = create_radio_input('Types of plot', plot_type)
    hue_check = st.checkbox("hue")
    ...
    features1 = st.selectbox('Select feature 1 (X variables)', features)
